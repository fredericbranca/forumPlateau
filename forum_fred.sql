...
-- Listage des données de la table forum_fred.post : ~6 rows (environ)
INSERT INTO `post` (`id_post`, `topic_id`, `user_id`, `message`, `creationdate`, `modifiedmessagedate`) VALUES
	...
	(88, 24, NULL, '&#60;p&#62;htrejetj&#60;/p&#62;', '2023-07-26 14:11:35', '2023-07-28 11:39:59'),
...
INSERT INTO `topic` (`id_topic`, `categorie_id`, `user_id`, `titre`, `message`, `creationdate`, `modifiedmessagedate`, `closed`) VALUES
	(24, 1, NULL, 'test', '&#60;p&#62;test&#60;/p&#62;', '2023-07-25 08:38:49', '2023-07-28 11:56:01', 0),
	(25, 2, 6, 'gebet', '&#60;p&#62;bethne&#60;/p&#62;', '2023-07-25 15:59:15', '2023-08-01 14:03:46', 0),
	...
	(30, 1, 20, 'test', '&#60;p&#62;test&#60;/p&#62;', '2023-08-01 14:09:24', NULL, 0);
...
INSERT INTO `user` (`id_user`, `nickname`, `email`, `password`, `creationdate`, `role`, `statut`) VALUES
	...
	(19, 'Paul', 'paul@gmail.com', '$2y$10$gNQJQPJ1.bB6CB8P/Bh3duYDN.q.9laCxpt4aYfjCTHxImPulxqpm', '2023-07-27 21:49:08', 'ROLE_USER', '2023-08-01 11:08:07'),
	(20, 'Alice', 'alice@gmail.com', '$2y$10$gNQJQPJ1.bB6CB8P/Bh3duYDN.q.9laCxpt4aYfjCTHxImPulxqpm', '2023-08-01 09:05:02', 'ROLE_USER', '2023-08-01 15:19:33');
